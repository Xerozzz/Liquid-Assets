...
// Note: the by-recipe endpoint returns a flattened { hm_ingredient_id, name, unit, quantity }
// shape (not the raw recipe_hm_ingredient entity), so it's returned as-is, unmapped.
